...
*Last updated: 2026-04-24 (Phase 1 Deliverable 5 close-out — Patch-C + Patch-G landed: death corpse-drop spawns bag contents at death coords for any-player loot, drag auto-route redirects tagged items back into the Extraction Pack; the PlaceableLootContainerComponent swap on the corpse template was the load-bearing architectural fix that unlocked drag-out. Phase 1 Deliverable 4b close-out — Patch-F landed: loot auto-route into extraction bag on-zone via lootAll. Phase 1 Deliverable 1 close-out — Patch-A landed, verified in-client. Each subsequent patch landing appends a commit + updates this table's Status column.*
