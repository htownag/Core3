...
*Last updated: 2026-04-23 (Phase 1 Deliverable 4b close-out — Patch-F landed: loot auto-route into extraction bag on-zone; Phase 1 Deliverable 1 close-out — Patch-A landed, verified in-client: extraction_outpost boots with Lok terrain, all 4 client UI surfaces read "Lok", vanilla zones regression-clean). Each subsequent patch landing appends a commit + updates this table's Status column.*
