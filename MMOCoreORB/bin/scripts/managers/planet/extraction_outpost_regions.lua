-- ExtractionMod-SWGEmu: vanilla-style regions file for extraction_outpost.
--
...
-- bin/scripts/custom_scripts/screenplays/extraction_mod/extraction_outpost_regions.lua
